<template>
  <div class="cooperation-filter-section">
    <div class="filter-section">
      <!-- 第一行 -->
      <div class="filter-row">
        <div class="filter-item">
          <span class="filter-label">合作单ID</span>
          <el-input
            v-model="localParams.cooperationId"
            placeholder="请输入合作单ID"
            clearable
            style="width: 160px"
            size="small"
          />
      ...
      <div class="filter-row" style="margin-top: 12px;">
        ...
        <div class="filter-item">
          <span class="filter-label">创建类型</span>
          <el-select
            v-model="localParams.createType"
            placeholder="全部"
            clearable
            style="width: 140px"
            size="small"
          >
            <el-option
              v-for="opt in createTypeOptions"
              :key="opt.value"
              :label="opt.label"
              :value="opt.value"
            />
