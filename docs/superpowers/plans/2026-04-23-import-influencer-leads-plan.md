# 导入达人线索 Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** 实现导入达人线索页面，包含平台Tab切换、筛选区、数据列表、添加/批量导入/批量操作功能

**Architecture:** 单文件Vue组件，参考NaturalOrderInfluencer.vue实现模式，包含完整的表格、弹窗、筛选功能
...
dohozz-saas/src/views/
  ImportInfluencerLeads.vue    # 导入达人线索主组件（新建）

dohozz-saas/src/views/Dashboard.vue  # 菜单配置（修改）
```

---

## Task 1: 创建 ImportInfluencerLeads.vue 组件基础结构

**Files:**
- Create: `dohozz-saas/src/views/ImportInfluencerLeads.vue`

- [ ] **Step 1: 创建组件基础模板和样式变量**
...
## Task 2: 在 Dashboard.vue 添加菜单项

**Files:**
- Modify: `dohozz-saas/src/views/Dashboard.vue:380-386`

- [ ] **Step 1: 在找达人子菜单中添加导入达人线索**

找到菜单配置位置（约380-386行），在自然出单达人后添加：
...
- [ ] **Step 2: 在模板中添加 ImportInfluencerLeads 组件引用**

在 Dashboard.vue 顶部 import 区域添加：
```javascript
...
**Files:**
- Verify: `dohozz-saas/src/views/ImportInfluencerLeads.vue`
...
```bash
git add dohozz-saas/src/views/ImportInfluencerLeads.vue dohozz-saas/src/views/Dashboard.vue
git commit -m "feat: 实现导入达人线索功能页面"
```
...
- [ ] Task 1: ImportInfluencerLeads.vue 基础结构创建完成
- [ ] Task 2: Dashboard.vue 菜单配置修改完成
- [ ] Task 3: 页面功能验证通过
- [ ] Task 4: 最终提交完成
