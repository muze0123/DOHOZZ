...
watch(() => props.visible, (val) => {
  ...
  if (val && props.influencer) {
    // Fill form with influencer data
    form.platform = props.influencer.platform || props.platform || 'douyin'
    form.streamer_name = props.influencer.streamer_name || ''
    form.streamer_account = props.influencer.streamer_account || ''
    form.streamer_category = props.influencer.streamer_category || ''
    form.contact_info = props.influencer.contact_info || ''
    form.remark = props.influencer.remark || ''
  }
})
...
const handleConfirm = async () => {
  ...
  try {
    ...
    const res = await api.updateInfluencer(props.influencer.streamer_id, {
