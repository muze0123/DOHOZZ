<template>
  <el-drawer v-model="dialogVisible" title="编辑团长合作" size="560px" @close="handleClose">
    <div class="form">
      <div class="form-row">
        <div class="form-item">
          <div class="form-label">团长名称</div>
          <div class="form-value">{{ cooperation?.leaderName }}</div>
        </div>
        <div class="form-item">
          <div class="form-label">合作单ID</div>
          <div class="form-value">{{ cooperation?.cooperationId }}</div>
        </div>
      </div>
      <div class="form-row">
        <div class="form-item">
