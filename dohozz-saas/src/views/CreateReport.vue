  ...
  <div class="create-report">
    ...
    <div class="page-header">
      <div class="header-left">
        ...
        <span class="page-title">创建报表</span>
      </div>
    </div>
    ...
    <div class="page-content">
      ...
      <!-- 区域D：字段配置 -->
      <div class="section-block field-section">
            ...
            >
              ...
              <div class="group-fields">
                ...
                >
                  ...
                  <span v-else-if="selectedFields.includes(field.id)" class="remove-icon" @click.stop="handleFieldRemove(field)">×</span>
                </div>
              </div>
            </div>
          </div>
...
const fieldGroups = ref([
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'contentLikes', label: '内容点赞', tooltip: '内容点赞数', isDefault: false },
  ...
  },
  {
    name: '达人指标',
    fields: [
      { id: 'talentCount', label: '达人数', tooltip: '相关达人数', isDefault: false },
      { id: 'contactCount', label: '建联数', tooltip: '成功建联数量', isDefault: false },
      { id: 'cooperationCount', label: '合作数', tooltip: '合作单数量', isDefault: false }
    ]
  },
  {
    name: '寄样指标',
    fields: [
      { id: 'sampleCount', label: '寄样数', tooltip: '寄样单数量', isDefault: false },
